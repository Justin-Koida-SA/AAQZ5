...
;;We almost finished everything. We implemented everything.
;;Sorry about the late submission, we just learned the assignment was actually due at 10.
;;We have a submission prior to 10 if it is recorded. We can prove we had most things in
;;our git hub repo if that is an issue.
